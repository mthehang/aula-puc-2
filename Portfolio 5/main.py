        ...
        if opcao == "1":
            ...
            if resultados:
                for res in resultados:
                    print(f"ID Serviço: {res[0]}, ID Atendimento: "
                          f"{res[1]}, TUSS: {res[2]}, Paciente: {res[3]}, Médico: {res[4]}")
            else:
                print(servico.erro or "Nenhum serviço fora da relação encontrado.")
            ...
            if resultados:
                for res in resultados:
                    print(f"Tipo de Serviço: {res[0]}, Quantidade: {res[1]}")
            else:
                print(servico.erro or "Nenhum dado encontrado.")
            input("\nPressione ENTER para continuar.")
            ...
            if resultados:
                for res in resultados:
                    print(f"Paciente: {res[0]}, ID Paciente: {res[1]}, Serviço: {res[2]}, Quantidade: {res[3]}")
            else:
                print(servico.erro or "Nenhum paciente encontrado.")
            input("\nPressione ENTER para continuar.")
            ...
            if resultados:
                for res in resultados:
                    print(f"Paciente: {res[0]}, Sexo: {res[1]}, "
                          f"Serviço: {res[2]}, ID Serviço: {res[3]}, ID Atendimento: {res[4]}")
            else:
                print(servico.erro or "Nenhum serviço incompatível encontrado.")
            input("\nPressione ENTER para continuar.")
            ...
            if resultados:
                for res in resultados:
                    print(f"ID Serviço: {res[0]}, ID Atendimento: {res[1]}, "
                          f"TUSS: {res[2]}, Paciente: {res[3]}, Médico: {res[4]}, Especialidade: {res[5]}")
            else:
                print(servico.erro or "Nenhum serviço fora da especialidade encontrado.")
            input("\nPressione ENTER para continuar.")
